...
public class ShotSpawnerTutorial : MonoBehaviour
{
    ...
    private void SetShotProperties(GameObject shot)
    {
        ...
        shot.GetComponent<ShotTutorial>().SetColor(shotColor);                      //dessen Farbe
        shot.GetComponent<ShotTutorial>().SetPlayerTeam(playerTeam);                //dessen Team
        shot.GetComponent<ShotTutorial>().SetShotID(shotCount);                     //sowie seine ID
