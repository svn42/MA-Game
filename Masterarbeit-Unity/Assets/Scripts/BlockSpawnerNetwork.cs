...
public class BlockSpawnerNetwork : MonoBehaviour
{
    ...
    public void SpawnBlock()
    {
        ...
        if (blockChargeTime == spawnTimer && spawnable)
        {
            ...
            block.GetComponent<BlockNetwork>().SetColor(blockColor); //und entsprechend der Teamfarbe eingefärbt
            block.GetComponent<BlockNetwork>().SetPlayerTeam(playerTeam);
            block.GetComponent<BlockNetwork>().SetBlockID(blockCount);
