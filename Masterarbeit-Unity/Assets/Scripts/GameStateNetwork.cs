...
public class GameStateNetwork : NetworkBehaviour
{
    ...
    private List<BallNetwork> ballList = new List<BallNetwork>();
    ...
    private PlayerNetwork player1Script;
    private PlayerNetwork player2Script;
    ...
    public void CheckPlayerCount()
    {
        ...
        if (playerList.Length == 2) {
            ...
            player1Script = player1.GetComponent<PlayerNetwork>();
            player2Script = player2.GetComponent<PlayerNetwork>();
    ...
    public void RegisterBallList(BallNetwork ball)
    {
        ballList.Add(ball);
    }

    //Die Methode liefert als return Wert die aktuelle ballList zurück
    public List<BallNetwork> GetBalllist()
    {
        return ballList;
    }
    ...
    IEnumerator StartDepauseCountdown(int countdown)
    {
        ...
        if (!gameStarted)
        {
            player1.GetComponent<PlayerNetwork>().FindEnemyPlayer(player2);
            player2.GetComponent<PlayerNetwork>().FindEnemyPlayer(player1);
            gameStarted = true;
        }
