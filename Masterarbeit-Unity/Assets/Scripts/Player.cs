...
public class Player : MonoBehaviour
{
    ...
    public void OnCollisionEnter2D(Collision2D coll)
    {
        if (coll.gameObject.tag == "Boundary")
        {
            ...
            {
                case "Boundary_Top":
                    transform.Translate(new Vector3(0f, -50, 0f) * Time.deltaTime, Space.World);
                    break;
                case "Boundary_Bottom":
                    transform.Translate(new Vector3(0f, 50, 0f) * Time.deltaTime, Space.World);
                    break;
                case "Boundary_Left":
                    transform.Translate(new Vector3(50, 0f, 0f) * Time.deltaTime, Space.World);
                    break;
                case "Boundary_Right":
                    transform.Translate(new Vector3(-50, 0, 0f) * Time.deltaTime, Space.World);
                    break;
            }
        }
        if (coll.gameObject.tag == "Ball")
        {
            ...
            blockSpawn.GetComponent<SpriteRenderer>().enabled = false; //und der Rahmen ausgeblendet
        }
    ...
    public void CheckInput()
    {
        ...
        if (Input.GetButton("Block"))
        {
            ...
            blockSpawn.GetComponent<SpriteRenderer>().enabled = true;       //und der Rahmen angezeigt
        }
    ...
    //Methode zum übermitteln des Betäubungseffektes an den Spieler
    ...
    {
        SpriteRenderer spriteRenderer = gameObject.GetComponent<SpriteRenderer>();
        int blinkAmount = (int) Mathf.Floor(time / stunBlinkEffect/2);
